...
<head>
    ...
    <style>
        ...
        .error-code { font-size: 8rem; font-weight: 800; color: #e2e8f0; line-height: 1; margin-bottom: -20px; }
        .error-icon { font-size: 4rem; color: #4f46e5; margin-bottom: 20px; }
    </style>
</head>
<body>
    <div class="error-container">
        <div class="error-card">
            ...
            <a href="{{ url('/') }}" class="btn btn-primary px-4 py-2 fw-bold shadow-sm" style="border-radius: 8px;">
