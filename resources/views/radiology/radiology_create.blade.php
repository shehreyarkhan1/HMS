                    ...
                    <div class="form-card-body">
                        ...
                        <select name="patient_id" class="form-select form-select-sm" required>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="notes" class="form-control form-control-sm" rows="1" placeholder="Additional notes..."></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-card-body">
                        <div class="mb-3">
                            <input type="text" id="examSearch" class="form-control form-control-sm"
                                placeholder="Search exam name..." onkeyup="filterExams(this.value)">
                        </div>

                        <div class="exam-catalog">
                            @foreach ($examsByModality as $modalityId => $group)
                                <div class="modality-group" data-modality="{{ $modalityId }}">
                                    <div class="modality-group-header" onclick="toggleGroup({{ $modalityId }})">
                                        <span>
            ...
            <div class="col-lg-4">
                <div class="form-card" style="position:sticky;top:20px">
                    ...
                    <div class="form-card-body">
                        ...
                        <div class="row g-2 mt-1">
                            <div class="col-12">
                                ...
                                <input type="number" name="discount" id="discountInput"
                                    ...
                                    oninput="updateNetDisplay()">
                            </div>

                            <div class="col-12 mt-2">
                                <div
                                    style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:8px;padding:10px 14px;display:flex;justify-content:space-between;align-items:center">
                        ...
                        <div class="mt-3 mb-3"
                            style="background:#fffbeb;border:1px solid #fde68a;border-radius:8px;padding:10px 12px;font-size:12px;color:#92400e;">
                        ...
                        <a href="{{ route('radiology.orders.index') }}" class="btn btn-outline-secondary w-100 mt-2"
