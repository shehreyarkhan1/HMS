...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        ...
        <div class="d-flex gap-2 align-items-center flex-wrap justify-content-end">
            ...
            @if ($ot->isEditable())
                <a href="{{ route('ot.schedules.edit', $ot->id) }}" class="btn btn-sm btn-warning px-3"
                    style="height:34px;font-size:13px">
                    <i class="bi bi-pencil me-1"></i>Edit
                </a>
            @endif
            <a href="{{ route('ot.index') }}" class="btn btn-sm btn-outline-secondary px-3"
                style="height:34px;font-size:13px">
    ...
    <div class="row g-4">
        ...
        <div class="col-12 col-xl-8">
            ...
            <div class="info-banner">
                <div class="row g-3 text-center">
                    ...
                    <div class="col-6 col-md-3">
                        <div style="font-size:11px;color:#94a3b8;text-transform:uppercase;letter-spacing:.05em">Est.
                            Duration</div>
                        <div style="font-size:14px;font-weight:700;color:#1e293b;margin-top:4px">
                    ...
                    <div class="col-6 col-md-3">
                        <div style="font-size:11px;color:#94a3b8;text-transform:uppercase;letter-spacing:.05em">OT Room
                        </div>
                        <div style="font-size:14px;font-weight:700;color:#1e293b;margin-top:4px">
                            {{ $ot->otRoom?->room_code ?? '—' }}
                        </div>
            ...
            <div class="detail-card">
                ...
                @if ($ot->procedure_details)
                    <div class="mt-3">
                        ...
                        <div
                            style="background:#f8fafc;border-radius:8px;padding:12px;font-size:13px;color:#374151;line-height:1.6">
                ...
                @if ($ot->pre_op_instructions)
                    <div class="mt-3">
                        ...
                        <div
                            style="background:#fffbeb;border:1px solid #fde68a;border-radius:8px;padding:12px;font-size:13px;color:#92400e;line-height:1.6">
                ...
                <div class="detail-card">
                    ...
                    @if ($ot->post_op_notes)
                        <div class="mb-3">
                            ...
                            <div
                                style="background:#f0fdf4;border-radius:8px;padding:12px;font-size:13px;color:#166534;line-height:1.6">
                    ...
                    @if ($ot->complications)
                        <div>
                            ...
                            <div
                                style="background:#fef2f2;border:1px solid #fecaca;border-radius:8px;padding:12px;font-size:13px;color:#991b1b;line-height:1.6">
        ...
        <div class="col-12 col-xl-4">
            ...
            <div class="detail-card">
                ...
                <div class="detail-row">
                    <span class="detail-label">Surgeon Fee</span>
                    <span class="detail-value">Rs. {{ number_format($ot->surgeon_fee, 2) }}</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Anesthesia Fee</span>
                    <span class="detail-value">Rs. {{ number_format($ot->anesthesia_fee, 2) }}</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">OT Room Charges</span>
                    <span class="detail-value">Rs. {{ number_format($ot->ot_room_charges, 2) }}</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Consumables</span>
                    <span class="detail-value">Rs. {{ number_format($ot->consumables_charges, 2) }}</span>
                </div>
                <div class="detail-row" style="border-top:1px solid #e2e8f0;margin-top:4px;padding-top:10px">
                    <span class="detail-label" style="font-weight:600;color:#374151">Total</span>
                    <span class="detail-value" style="color:#6366f1;font-size:15px">
                        Rs. {{ number_format($ot->total_ot_cost, 2) }}
                    </span>
                </div>
                <div class="mt-2">
                    <span
                        style="font-size:11px;padding:2px 10px;border-radius:6px;font-weight:600;
            {{ $ot->billing_status === 'Paid'
                ? 'background:#dcfce7;color:#166534'
                : ($ot->billing_status === 'Billed' || $ot->billing_status === 'Partial'
