        ...
        <form method="POST" action="{{ route('pharmacy.medicines.store') }}" novalidate>
            ...
            <div class="form-card">
                <div class="form-card-header">
                    <div class="section-icon" style="background:#dbeafe;color:#1d4ed8"><i class="bi bi-capsule-pill"></i>
                    </div>
                ...
                <div class="form-card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="brand" class="form-control-custom" value="{{ old('brand') }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="unit" class="form-select-custom">
                                @foreach (['Tablet', 'Capsule', 'Strip', 'ml', 'mg', 'g', 'Vial', 'Ampoule', 'Tube', 'Bottle', 'Sachet', 'Piece'] as $u)
                                    <option value="{{ $u }}"
                                        {{ old('unit', 'Tablet') == $u ? 'selected' : '' }}>{{ $u }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-4">
                            ...
                            <select name="storage_condition" class="form-select-custom">
                                ...
                                @foreach (['Room Temperature','Store below 25°C','Refrigerate (2-8°C)', 'Freeze', 'Away from light', 'Keep dry'] as $s)
                                    <option value="{{ $s }}"
                                        {{ old('storage_condition') == $s ? 'selected' : '' }}>{{ $s }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
            ...
            <div class="form-card">
                <div class="form-card-header">
                    <div class="section-icon" style="background:#dcfce7;color:#15803d"><i class="bi bi-currency-dollar"></i>
                    </div>
                ...
                <div class="form-card-body">
                    ...
                    <div
                        style="margin-top:12px;padding:10px 14px;background:#fffbeb;border-radius:8px;font-size:12px;color:#854d0e">
                        <i class="bi bi-info-circle me-1"></i>
                        Stock will be added separately via batches after saving. Batches track expiry dates and supplier
                        info.
                    </div>
                </div>
            </div>
