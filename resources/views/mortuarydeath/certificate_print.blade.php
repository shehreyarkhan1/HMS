...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .print-toolbar-sub   { font-size: 11px; color: #94a3b8; margin-top: 2px; }
        .btn-print {
        ...
        .cert-meta-row .val { font-weight: 700; color: #1a1a1a; }
        ...
        .declaration strong { font-style: normal; color: #1a1a1a; font-weight: 700; }
        ...
        <div class="content">
            ...
            <div class="header">
                <div class="hospital-logo-row">
                    ...
                    <div>
                        <div class="hospital-name">{{ config('app.hospital_name', 'City General Hospital') }}</div>
                        <div class="hospital-meta">
                            {{ config('app.hospital_address', 'Main Road, City — Pakistan') }}<br>
                            Tel: {{ config('app.hospital_phone', '+92-XXX-XXXXXXX') }} &nbsp;|&nbsp;
                            Reg. No: {{ config('app.hospital_reg', 'PMDC/HOSP/XXXX') }}
                        </div>
                    </div>
                </div>
                ...
                <div class="cert-meta-row">
                    ...
                    <div>Issue Date: <span class="val">{{ \Carbon\Carbon::parse($certificate->issued_at)->format('d F Y') }}</span></div>
                    <div>Copy: <span class="val">{{ $certificate->copy_number }} of {{ $certificate->total_copies }}</span></div>
                </div>
            </div>
            ...
            <div class="info-grid triple">
                <div class="info-row">
                    ...
                    <span class="val">{{ \Carbon\Carbon::parse($certificate->mortuaryRecord->death_datetime)->format('d F Y') }}</span>
                </div>
                <div class="info-row">
                    <span class="lbl">Time of Death</span>
                    <span class="val">{{ \Carbon\Carbon::parse($certificate->mortuaryRecord->death_datetime)->format('h:i A') }}</span>
                </div>
                <div class="info-row">
            ...
            <div class="cause-box">
                ...
                <div class="cause-row">
                    <div class="cause-part-label">Part I (a)<br><span style="font-weight:400;font-size:7.5px;color:#aaa">Immediate Cause</span></div>
                    <div class="cause-part-val">{{ $certificate->mortuaryRecord->immediate_cause }}</div>
                </div>
                <div class="cause-row">
                    <div class="cause-part-label">Part I (b)<br><span style="font-weight:400;font-size:7.5px;color:#aaa">Intermediate Cause</span></div>
                ...
                <div class="cause-row">
                    <div class="cause-part-label">Part I (c)<br><span style="font-weight:400;font-size:7.5px;color:#aaa">Underlying Cause</span></div>
                    <div class="cause-part-val">
                ...
                <div class="cause-row">
                    <div class="cause-part-label">Part II<br><span style="font-weight:400;font-size:7.5px;color:#aaa">Contributing Cause</span></div>
                    <div class="cause-part-val">
                ...
                <div class="cause-row" style="background:#fff8f8">
                    <div class="cause-part-label">Postmortem<br><span style="font-weight:400;font-size:7.5px;color:#aaa">Status</span></div>
            ...
            {{-- ── ISSUED TO ── --}}
            <div class="sec-heading">{{ $certificate->mortuaryRecord->is_medico_legal ? 'V' : 'IV' }}. Certificate Issued To</div>
            <div class="issued-box">
                <div class="info-grid">
                    ...
                    <div class="info-row">
                        ...
                        <span class="val">{{ $certificate->issuedBy?->first_name }} {{ $certificate->issuedBy?->last_name }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="declaration">
                ...
                was declared dead on <strong>{{ \Carbon\Carbon::parse($certificate->mortuaryRecord->death_datetime)->format('d F Y') }}</strong>
                at <strong>{{ \Carbon\Carbon::parse($certificate->mortuaryRecord->death_datetime)->format('h:i A') }}</strong>
            ...
            <div class="sig-section">
                ...
                {{-- Hospital Stamp --}}
                <div class="sig-box">
                    <div class="sig-space" style="border: 1.5px dashed #ccc; display:flex; align-items:center; justify-content:center; color:#ccc; font-size:9px; letter-spacing:.5px">
                        HOSPITAL STAMP
                    </div>
