                    ...
                    <div class="form-card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="notes" rows="2" class="form-control" placeholder="Additional notes...">{{ old('notes') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="rx-item-row" id="item_0">
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="number" name="items[0][duration_days]" class="form-control"
                                            value="3" min="1">
                                    </div>
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="items[0][frequency]" id="freq_0"
                                            class="form-control" placeholder="1-0-1">
                                        <div class="d-flex gap-1 mt-1 flex-wrap">
                                            @foreach (['1-0-1', '1-1-1', '0-0-1', 'TDS', 'BD', 'OD'] as $f)
                                                <span class="freq-btn"
                                                    onclick="setFreq(0, '{{ $f }}')">{{ $f }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <div class="col-md-6">
    ...
    <template id="itemTemplate">
        <div class="rx-item-row" id="item___IDX__">
            ...
            <div class="row g-2">
                    ...
                    <select name="items[__IDX__][medicine_id]" class="form-select">
                        ...
                        @foreach ($medicines as $med)
                            <option value="{{ $med->id }}" data-unit="{{ $med->unit }}">
                                {{ $med->name }}@if ($med->generic_name)
                                    ({{ $med->generic_name }})
                                @endif — {{ $med->total_stock }} in stock
                            </option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="col-md-2">
                    <label class="form-label">Days</label>
                    <input type="number" name="items[__IDX__][duration_days]" class="form-control" value="3"
                        min="1">
                </div>
                <div class="col-md-2">
                    <label class="form-label">Qty</label>
                    <input type="number" name="items[__IDX__][quantity]" class="form-control" value="1"
                        min="1">
                </div>
                ...
                <div class="col-md-6">
                    <label class="form-label">Frequency</label>
                    <input type="text" name="items[__IDX__][frequency]" id="freq___IDX__" class="form-control"
                        placeholder="1-0-1">
                    <div class="d-flex gap-1 mt-1 flex-wrap">
                ...
                <div class="col-md-6">
                    <label class="form-label">Instructions</label>
                    <input type="text" name="items[__IDX__][instructions]" class="form-control"
                        placeholder="After meal, before sleep...">
                </div>
            </div>
        </div>
