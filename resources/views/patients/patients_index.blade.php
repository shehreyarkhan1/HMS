            ...
            <div class="d-flex align-items-center gap-2 flex-wrap">
                ...
                <form method="GET" action="{{ route('patients.index') }}" class="filter-bar">
                    ...
                    <select name="status">
                        ...
                        <option value="Discharged" {{ request('status') == 'Discharged' ? 'selected' : '' }}>Discharged
                        </option>
                    </select>
                    ...
                    @if (request()->hasAny(['search', 'type', 'status']))
                        <a href="{{ route('patients.index') }}" class="btn btn-sm btn-outline-secondary px-3"
                ...
                {{-- Add New --}}
                <a href="{{ route('patients.create') }}" class="btn btn-sm btn-success px-3"
                    style="height:36px;font-size:13px">
