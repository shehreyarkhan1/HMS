...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\SOFTECH SQURE SOLUTIONS PROJECTS\hospital-management-system\public\storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.D:\\SOFTECH SQURE SOLUTIONS PROJECTS\\hospital-management-system\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'signed','throttle','verified',);
        registerArgumentsSet('routes', 'admin.users.index','admin.users.create','admin.users.store','admin.users.show',
'admin.users.edit','admin.users.update','admin.users.destroy','admin.users.toggle-status','dashboard',
'dashboard','patients.index','patients.create','patients.store','patients.show',
'patients.edit','patients.update','patients.destroy','doctors.index','doctors.create',
'doctors.store','doctors.show','doctors.edit','doctors.update','doctors.destroy',
'doctors.toggle-availability','appointments.calendar','appointments.availability','appointments.status','appointments.index',
'appointments.create','appointments.store','appointments.show','appointments.edit','appointments.update',
'appointments.destroy','wards.assign-bed','wards.beds.discharge','wards.beds.status','wards.index',
'wards.create','wards.store','wards.show','wards.edit','wards.update',
'wards.destroy','pharmacy.medicines.add-stock','pharmacy.medicines.index','pharmacy.medicines.create','pharmacy.medicines.store',
'pharmacy.medicines.show','pharmacy.medicines.edit','pharmacy.medicines.update','pharmacy.medicines.destroy','pharmacy.prescriptions.index',
'pharmacy.prescriptions.create','pharmacy.prescriptions.store','pharmacy.prescriptions.show','pharmacy.prescriptions.destroy','pharmacy.prescriptions.cancel',
'pharmacy.dispensings.index','pharmacy.dispensings.create','pharmacy.dispensings.store','pharmacy.dispensings.show','lab.orders.index',
'lab.orders.create','lab.orders.store','lab.orders.show','lab.orders.collectSample','lab.orders.storeResults',
'lab.orders.recordPayment','lab.orders.cancel','lab.orders.deliverReport','lab.results.verify','lab.tests.index',
'lab.tests.create','lab.tests.store','lab.tests.edit','lab.tests.update','lab.tests.toggleActive',
'lab.tests.price','lab.categories.index','lab.categories.store','lab.categories.update','lab.categories.destroy',
'lab.categories.toggleActive','lab.sample-types.index','lab.sample-types.store','lab.sample-types.update','lab.sample-types.destroy',
'lab.sample-types.toggleActive','radiology.orders.index','radiology.orders.create','radiology.orders.store','radiology.orders.show',
'radiology.orders.startScan','radiology.orders.completeScan','radiology.orders.storeReport','radiology.orders.schedule','radiology.orders.recordPayment',
'radiology.orders.deliverReport','radiology.orders.cancel','radiology.reports.verify','radiology.reports.amend','radiology.modalities.index',
'radiology.modalities.create','radiology.modalities.store','radiology.modalities.edit','radiology.modalities.update','radiology.modalities.destroy',
'radiology.modalities.toggle','radiology.body-parts.index','radiology.body-parts.create','radiology.body-parts.store','radiology.body-parts.edit',
'radiology.body-parts.update','radiology.body-parts.destroy','radiology.body-parts.toggle','radiology.exams.index','radiology.exams.create',
'radiology.exams.store','radiology.exams.show','radiology.exams.edit','radiology.exams.update','radiology.exams.destroy',
'radiology.exams.toggleStatus','employees.index','employees.create','employees.store','employees.show',
'employees.edit','employees.update','employees.destroy','ot.schedules.create','ot.schedules.store',
'ot.schedules.show','ot.schedules.edit','ot.schedules.update','ot.schedules.destroy','ot.index',
'ot.schedules.status','ot.rooms.index','ot.rooms.store','ot.rooms.update','ot.rooms.destroy',
'blood-bank.index','blood-bank.donors.index','blood-bank.donors.create','blood-bank.donors.store','blood-bank.donors.show',
'blood-bank.donors.edit','blood-bank.donors.update','blood-bank.donors.destroy','blood-bank.donations.index','blood-bank.donations.store',
'blood-bank.donations.screening','blood-bank.donations.destroy','blood-bank.requests.index','blood-bank.requests.store','blood-bank.requests.show',
'blood-bank.requests.status','blood-bank.requests.destroy','blood-bank.issues.store','blood-bank.issues.reaction','blood-bank.crossmatch.store',
'blood-bank.crossmatch.result','billing.index','billing.create','billing.store','billing.ajax.patient-search',
'billing.pending-services','billing.service-charges.index','billing.service-charges.create','billing.service-charges.store','billing.service-charges.edit',
'billing.service-charges.update','billing.service-charges.destroy','billing.service-charges.toggle','billing.show','billing.edit',
'billing.update','billing.finalize','billing.payment','billing.cancel','billing.print',
'storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'appointments.appointments_calendar','appointments.appointments_create','appointments.appointments_edit','appointments.appointments_index','appointments.appointments_show',
'billing.billing_create','billing.billing_edit','billing.billing_index','billing.billing_show','billing.print_invoice',
'billing.service_charge_form','billing.service_charge_index','bloodbank.blood_donor_create','bloodbank.blood_donor_edit','bloodbank.blood_donor_index',
'bloodbank.blood_donor_show','bloodbank.blood_request_index','bloodbank.blood_request_show','bloodbank.dashboard_index','bloodbank.donation_index',
'dashboard.index','dispensing.dispensings_create','dispensing.dispensings_index','doctors.doctors_create','doctors.doctors_edit',
'doctors.doctors_index','doctors.doctors_show','employee.employee_create','employee.employee_edit','employee.employee_index',
'employee.employee_show','labcategory.lab_category_index','labcategory.lab_sample_type_index','laboratory.lab_create','laboratory.lab_index',
'laboratory.lab_show','laboratory.test_create','laboratory.test_edit','laboratory.test_index','layouts.master',
'operationtheater.operation_create','operationtheater.operation_edit','operationtheater.operation_index','operationtheater.operation_show','operationtheater.otroom_form',
'operationtheater.otroom_index','patients.patients_create','patients.patients_edit','patients.patients_index','patients.patients_show',
'pharmacy.medicines_create','pharmacy.medicines_edit','pharmacy.medicines_index','pharmacy.medicines_show','prescription.prescriptions_create',
'prescription.prescriptions_index','prescription.prescriptions_show','radiology.body_part_create_edit_model','radiology.body_part_index','radiology.modality_create',
'radiology.modality_edit','radiology.modality_form','radiology.modality_index','radiology.radiology_create','radiology.radiology_exam_create',
'radiology.radiology_exam_edit','radiology.radiology_exam_index','radiology.radiology_exam_show','radiology.radiology_index','radiology.radiology_show',
'users.user_create','users.user_edit','users.user_index','users.user_show','wards.wards_create',
'wards.wards_edit','wards.wards_index','wards.wards_show','welcome','laravel-exceptions-renderer::components.badge',
...
'D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'D:.SOFTECH SQURE SOLUTIONS PROJECTS.hospital-management-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
